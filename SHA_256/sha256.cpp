...
//Purpose: Implementation of SHA-256 using C++
...
int main(int argc, char *argv[])
{
	...
	string str;
   	if(f) {
      ostringstream ss;
      ss << f.rdbuf(); // reading the data
      str = ss.str();	//storing the data in str variable 
   }
	cout << "SHA-256 HASH: " << sha256(str) << endl;	//Displaying the result hash
    return 0;
}
...
//Function to initialize hash values
void SHA256::init()
{
    m_h[0] = 0x6a09e667;
    m_h[1] = 0xbb67ae85;
...
void SHA256::update(const unsigned char *message, unsigned int len)
{
 ...
 //Function to produce final hash value
